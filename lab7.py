...
def big_cities():
    ...
    # 1 line solution with list comprehension for fun
    cities = [line[0] for line in [line.strip().split(',') for line in file.readlines()] if line[2] >= 1000000].sort()
...
def state_city_count():
    ...
    for line in lines:
        ...
        if city['state'] in city_counts:
            ...
            city['state'] = 0
    return {} # placeholder code. feel free to modify this.
